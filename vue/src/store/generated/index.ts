...
import MhAhmadAliPLHelloMhAhmadAliPLHelloHello from './MhAhmadAliPL/hello/MhAhmadAliPL.hello.hello'
...
export default { 
  MhAhmadAliPLHelloMhAhmadAliPLHelloHello: load(MhAhmadAliPLHelloMhAhmadAliPLHelloHello, 'MhAhmadAliPL.hello.hello'),
